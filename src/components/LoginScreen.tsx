...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, onNavigate }) => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-purple-50 to-teal-50 p-6 flex flex-col md:rounded-2xl">
      <div className="flex-1 flex flex-col justify-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {isSignUp && (
            <div className="relative">
              <input
                type="text"
                placeholder="Full Name (e.g., Janhavi Sharma)"
                value={formData.name}
          ...
          <div className="relative">
            ...
            <input
              type="email"
              placeholder="Email (e.g., janhavi.sharma@college.edu)"
          ...
          <button
            type="submit"
            className={`w-full py-3 text-white rounded-xl font-semibold shadow-md hover:shadow-lg transition-all duration-200 hover-lift ${
              userType === 'student' 
        ...
        <div className="mt-6">
          ...
          <button
           ...
           className="w-full mt-4 py-3 bg-white border border-gray-200 rounded-xl font-semibold text-gray-700 card-shadow hover:card-shadow-hover transition-all duration-200 hover-lift flex items-center justify-center space-x-2"
          >
